              ...
              <div className="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                <div className="dropdown">
                  ...
                  <ul className="dropdown-menu" aria-labelledby="dropdownMenu1">
                    <li><a href="#" className="sort_selected"><span className="fa fa-sort-alpha-asc pr-5">Tên A-Z</span></a></li>
                    <li><a href="#"className><span className="fa fa-sort-alpha-desc pr-5">Tên Z-A</span></a></li>
                    <li role="separator" className="divider" />
                    <li><a href="#" className>Trạng Thái Kích Hoạt</a></li>
                    <li><a href="#" className>Trạng Thái Ẩn</a></li>
                  </ul>
                </div>
              </div>
            </div>
